...
const education = [
  {
    ...
    highlights: ["Scalable Frontend Architectures", "Performance Optimization"],
  },
  {
...
export default function AboutPage() {
  ...
  const skillIcons: Record<string, ReactNode> = {
    ...
    tailwind: (
      ...
      >
        <path
          d="M4 13c4-2 6-2 10 0 4 2 6 2 10 0"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M4 9c4-2 6-2 10 0 4 2 6 2 10 0"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    css3: (
      ...
      >
        <path
          d="M4 3h16l-1.4 15.4L12 21l-6.6-2.6L4 3z"
          stroke="#0ea5e9"
          strokeWidth="1.2"
        />
        <path
    ...
    sass: (
      ...
      >
        <path
          d="M12 21c4-1 7-3 8-7 0-2-1-4-3-5-2-1-5 0-5 2 0 2 1 3 3 4"
          stroke="#ec4899"
          strokeWidth="1.2"
          strokeLinecap="round"
          strokeLinejoin="round"
    ...
    git: (
      ...
      >
        <path
          d="M15 7a2 2 0 11-4 0 2 2 0 014 0zM7 14a2 2 0 11-4 0 2 2 0 014 0zM18 17a2 2 0 11-4 0 2 2 0 014 0z"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen w-full bg-background selection:bg-primary/20 font-sans"
    >
      {/* Background Decor */}
            ...
            <div className="space-y-6">
              <div className="p-6 rounded-2xl bg-gradient-to-b from-surface/8 to-transparent">
                <h1 className="text-4xl font-bold tracking-tight mb-1 text-foreground">
                  My Professional <br />
                  <span className="text-muted-foreground/40">Journey</span>
                </h1>
          ...
          <main className="py-12 lg:py-24 space-y-32 max-w-5xl">
              ...
              <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-16 md:mb-24">
                ...
                <div className="space-y-6 md:space-y-8">
                  <div className="space-y-4">
                    <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter leading-[1.1] md:leading-[0.9]">
                      Engineer. <br />
                  ...
                  <div className="prose prose-sm dark:prose-invert max-w-none">
                    <p className="font-light leading-relaxed text-muted-foreground/80 text-sm md:text-base">
                      With{" "}
                      <span className="text-foreground font-medium">
                        2+ years of frontend engineering experience
                      </span>
                      , I specialize in the React ecosystem, crafting scalable
                      architectures. My philosophy: write clean code, optimize
                      for performance, never compromise on UX.
                    </p>
                  </div>
                </div>

                {/* Photo / Visual */}
                <div className="relative h-[400px] lg:h-[600px] min-h-[300px] rounded-3xl overflow-hidden bg-surface-secondary/30 border border-white/5 group">
                  <div className="absolute inset-0 bg-gradient-to-tr from-primary/20 via-transparent to-blue-500/10 opacity-60 group-hover:opacity-100 transition-opacity duration-700 z-20" />

                  <Image
                    src="/profile.png"
                    alt="Profile"
                    fill
                    className="object-cover object-top transition-transform duration-700 group-hover:scale-105 brightness-[0.85]"
                  />

                  {/* Dark gradient overlay for better text visibility & blending */}
                  <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10" />

                  {/* Floating Badge */}
                  <div className="absolute bottom-5 left-5 bg-black/50 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10 z-30 shadow-lg hover:bg-black/60 transition-colors">
                    <div className="flex items-center gap-2">
                      <div className="h-1.5 w-1.5 rounded-full bg-green-500 animate-pulse shadow-[0_0_5px_rgba(34,197,94,0.6)]" />
            ...
            <section id="experience" className="resume-section scroll-mt-32">
              <div className="flex items-center gap-4 mb-12 md:mb-20">
                <h2 className="text-xs md:text-sm font-mono tracking-[0.2em] text-primary uppercase">
                  Career History
                </h2>
                <div className="h-px bg-border flex-1 max-w-[100px] md:max-w-[200px]"></div>
              </div>

              <div className="relative border-l border-primary/10 ml-2 md:ml-0 space-y-16 md:space-y-24">
                {experiences.map((exp, idx) => (
                  <div key={idx} className="relative pl-6 md:pl-16 group">
                    {/* Timeline Node */}
                    <div className="absolute left-[-4.5px] top-2 h-2.5 w-2.5 rounded-full bg-border group-hover:bg-primary transition-colors duration-500 ring-4 ring-background" />
                    ...
                    <div className="grid md:grid-cols-[180px_1fr] gap-4 md:gap-12 items-start">
                      <span className="font-mono text-xs md:text-sm text-muted-foreground uppercase tracking-wider py-1.5">
                        {exp.period}
                      </span>
                      ...
                      <div>
                        ...
                        <div className="text-primary text-lg md:text-xl font-medium mb-4 md:mb-8">
                          {exp.role}
                        </div>
                        ...
                        <ul className="space-y-3 md:space-y-4 mb-6 md:mb-8">
                          {exp.achievements.map((item, i) => (
                            <li
                              key={i}
                              className="flex items-start gap-3 text-sm md:text-base text-muted-foreground/80 group-hover:text-muted-foreground transition-colors"
                            >
                        ...
                        <div className="flex flex-wrap gap-2">
                          {exp.technologies.map((tech) => (
                            <span
                              key={tech}
                              className="text-xs md:text-sm px-3 md:px-4 py-1 md:py-1.5 rounded-full bg-surface-secondary border border-border/50 text-muted-foreground transition-colors hover:border-primary/30 hover:text-primary cursor-default"
                            >
                              {tech}
                            </span>
                          ))}
            ...
            <section id="skills" className="resume-section scroll-mt-32">
              ...
              <div className="space-y-12 md:space-y-20">
                {[
                  ...
                  <div key={idx}>
                    <h3 className="text-xs md:text-sm font-mono text-primary/50 mb-4 md:mb-8 uppercase tracking-widest">
                      {category.title}
                    </h3>
                    <div className="flex flex-wrap gap-x-3 gap-y-2 md:gap-x-8 md:gap-y-4">
                      {category.skills.map((skill) => (
                        <span
                          key={skill}
                          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground/80 hover:text-primary transition-colors cursor-default tracking-tight"
                        >
                          {skill}
                        </span>
                      ))}
              ...
              <div className="flex items-center justify-between mb-12">
                ...
                <div className="hidden md:flex gap-4">
                  <button
                    onClick={() =>
                      document
                        .getElementById("education-slider")
              ...
              <div className="relative w-full -mx-4 md:mx-0">
                ...
                >
                  {education.map((edu, idx) => (
                    <div
                      key={idx}
                      className="snap-start shrink-0 w-[85vw] md:w-[420px] md:h-[480px] group relative bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/5 hover:border-white/20 p-8 rounded-3xl transition-all duration-300 hover:shadow-2xl hover:shadow-primary/5 hover:-translate-y-1 select-none cursor-grab active:cursor-grabbing"
                    >
                      ...
                      <div className="relative z-10 h-full flex flex-col">
                        ...
                        <div className="flex flex-wrap gap-2 mt-6">
                          {edu.highlights.map((h, i) => (
                            <span
                              key={i}
                              className="text-[10px] font-medium px-2.5 py-1 bg-white/5 border border-white/5 rounded-full text-muted-foreground group-hover:text-white group-hover:border-white/10 transition-all duration-300"
                            >
                              {h}
                            </span>
                          ))}
